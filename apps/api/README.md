...
FastAPI backend for Convo chat management platform built with Clean Architecture principles.

## Overview

The API manages companies, users, contacts, chats, and messages with webhook integration. It follows Clean Architecture with clear layer separation between Domain, Application, Infrastructure, and Web layers.
